...
const loginRouteData: ExternalUrlRouteData = {
  targetUrl: new URL('https://skydevelopers.auth.us-east-1.amazoncognito.com/login?response_type=token&client_id=2fe9dfh5ictve3n26c3jjvph2l&redirect_uri=https://oidcdebugger.com/debug')
};
