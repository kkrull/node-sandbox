...
const ACCESS_TOKEN = 'IdentityServerAccessToken';
const ID_TOKEN = 'IdentityServerIdToken';

@Injectable()
export class IdentityServerTokenStorageService extends TokenStorageService {
